...
sudo wget -q  wget https://raw.githubusercontent.com/pietrofesar/testMe/master/learningPythonSolutions.py -O /usr/bin/testMeFolder/learningPythonSolutions.py
